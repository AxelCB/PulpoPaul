$(document).ready(function() {
   ...
   $('.glyphicon-eye-open').click(function(){
	  ...
	  if($(row[6]).text() != '0'){
		  var str = '<br>';
		  str += '<a href="xxx?idMensaje=' + $(row[0]).text() + '&aceptar=true" class="btn btn-success">Aceptar</a>'
		  str += '<a href="xxx?idMensaje=' + $(row[0]).text() + '?aceptar=false" class="btn btn-danger">Rechazar</a>';
